                        ...
                        <?php 
                            if (isset($_POST['user'])){
                                ...
                                if ($user == "" || $pass == ""){
                                    ...
                                    $result = queryMySQL("SELECT email,secret FROM manager WHERE email='$user' AND secret='$token'");
                                }
                                if ($result->num_rows == 0){
                                    ...
                                    $_SESSION['user'] = $user;
                                    $_SESSION['pass'] = $token;
                                    die("<br><br>Welcome, $user you are now logged in. Please <a href='fau.php'>" . "click here</a> to continue.<br><br>");
                                }
                            }
                            ?>
                    </form>
